...
class PlayAudioBtnZikrPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      if (url == null || audioController.currentMediaId.value == id) {
        return Container(); // Hide the button if this track is playing
      }
  ...
  Widget _buildPlayButton(
    ...
    if (isFileDownloaded) {
      return IconButton(
        // ---- CHANGE IS HERE ----
        // Pass the unique ID to initPlayer
        onPressed: () => audioController.initPlayer(id, url!, title, true),
