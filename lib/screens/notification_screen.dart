...
class _NotificationSettingsState extends State<NotificationSettings> {
  ...
  // Check the app's logical service state
    if (mounted) {
      setState(() {
  ...
  if (_controller.prayerTimings.value == null) {
          return const Center(
            child: Text(
  ...
  final duration = _controller.timeLeft.value;
  final nextPrayer = _controller.nextPrayerInfo.value.$2;
  ...
  Widget _buildPrayerTimeRow(String prayer, String time) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isCurrentPrayer ? Colors.green : Colors.grey.withValues(alpha: 0.3),
        ),
      ),
      child: Row(
